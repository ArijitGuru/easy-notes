...
public class NoteController {
	...
	// Get All Notes
	@GetMapping ("/notes") // it is a short form of 
	...
	public Note createNote (@Valid @RequestBody Note note) {
		...
		// Remember, Note's title and content with @NotBlank annotation in the Note model?
		// If the request body does not have a title or a content, then Spring will return a 400 BadRequest error in the client.
